...
import SliderControl from '@registry/default/ui/slider-control';
import { Sheet, SheetTitle, SheetContent } from '@registry/default/ui/sheet';
...
const SettingsPanelProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <SettingsPanelContext.Provider value={contextValue}>{children}</SettingsPanelContext.Provider>
  );
};
    ...
    <>
      ...
      <div className="h-12 flex item-center">
        <div className="flex items-center gap-2">
          <PenLine className="text-muted-foreground/70" size={20} aria-hidden="true" />
...
const SettingsPanel = () => {
  ...
  return (
    <ScrollArea>
      <div className="w-[250px] px-4 md:px-6">
        <SettingsPanelContent />
      </div>
    </ScrollArea>
  );
