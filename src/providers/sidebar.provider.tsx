  ...
  return (
    ...
    >
      {open ? (
        ...
        <PanelRight className="size-5.5" size={22} aria-hidden="true" />
      )}
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground/70 ring-sidebar-ring flex mb-3 shrink-0 items-center rounded-md px-2 !text-[10px] font-medium outline-hidden transition-[margin,opacity] duration-200 ease-in-out focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
