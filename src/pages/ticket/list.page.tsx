...
import List from '@/components/ticket/list.component';
  ...
  return (
    <>
      ...
      <div className="flex  items-center justify-between gap-4">
        <div className="">
          <h1 className="text-xl font-extrabold">Tickets</h1>
          <p className="text-sm text-muted-foreground">
            Here&rsquo;s an overview of your contacts. Manage or create new ones with ease!
          </p>
        </div>
        {/* <NewTicket/> */}
        <Button size={'sm'} className="px-3" onClick={() => navigate('/ticket/new')}>
          <PlusIcon />
          New ticket
        </Button>
      </div>
