...
import { ListIcon } from '@registry/default/components/tiptap/tiptap-icons/list-icon';
...
import {
  ...
  listOptions,
  type ListType,
} from '@registry/default/components/tiptap/tiptap-ui/list-button/list-button';
